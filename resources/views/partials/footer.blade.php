        ...
        <div class="row g-3">
            <div class="col-lg-4 col-md-6">
                ...
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-secondary mb-2" href={{ route('accueil') }}><i
                            class="bi bi-arrow-right text-primary me-2"></i>Accueil</a>
                    <a class="text-secondary mb-2" href={{ route('apropos') }}><i
                            class="bi bi-arrow-right text-primary me-2"></i>A
                        propos</a>
                    <a class="text-secondary mb-2" href={{ route('services') }}><i
                            class="bi bi-arrow-right text-primary me-2"></i>Services</a>
                    <a class="text-secondary mb-2" href={{ route('actualites') }}><i
                            class="bi bi-arrow-right text-primary me-2"></i>Actualites</a>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <p class="mb-2"><i class="bi bi-geo-alt text-primary me-2"></i>Rue Weem-doogo, Quartier Wentenga,
                    Ouagadougou, Burkina Faso</p>
                <p class="mb-2"><i class="bi bi-envelope-open text-primary me-2"></i>info@acm-vistra.com</p>
                <p class="mb-0"><i class="bi bi-telephone text-primary me-2"></i>+226 25 48 75 25 - 61 41 68 68</p>
            </div>
            <div class="col-lg-4 col-md-6">
    ...
    <div class="container-fluid bg-dark text-secondary text-center border-top py-4 px-5"
        ...
        <p class="m-0">&copy; <a class="text-secondary border-bottom" href="#">ACM-VISTRA</a>. All Rights Reserved.
            Powered by <a class="text-secondary border-bottom" href="https://htmlcodex.com">GeeC</a></p>
    </div>
    <!-- Footer End -->
